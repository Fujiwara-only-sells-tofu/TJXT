...
public class CourseDraftServiceImpl extends ServiceImpl<CourseDraftMapper, CourseDraft> implements ICourseDraftService {
    ...
    public CourseSaveVO save(CourseBaseInfoSaveDTO courseBaseInfoSaveDTO) {
        ...
        //2.2.课程封面和课程下架时间
        courseDraft.setCoverUrl("https://1330636567.vod-qcloud.com/b59021d1vodsh1330636567/786b61781397757895598242422/BRowyc0WiXgA.jpg");
    ...
    public void upShelf(Long id) {
        ...
        if (isFirstUpShelf) {
            ...
            courseToShelf.setCoverUrl("/img-tx/default-cover-url.jpg");
            //4.5.2.插入课程基本信息
